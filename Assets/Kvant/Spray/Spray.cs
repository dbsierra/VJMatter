...
namespace Kvant
{
    ...
    public partial class Spray : MonoBehaviour
    {
        ...
        public float dragMult = 1.0f;

        [SerializeField]
        public Vector3 accelerationAdder;
        public float accelerationMult;

        public float drag {
            get { return _drag * dragMult; }
            set { _drag = value; }
        }
        ...
        [Range(0.0f, 1.0f)]
        public float _particleScaleMultiplier = 1.0f;
        ...
        void UpdateKernelShader()
        {
            ...
            var drag = Mathf.Exp(-_drag * dragMult * deltaTime);
            var aparams = new Vector4(_acceleration.x*accelerationMult + accelerationAdder.x, _acceleration.y* accelerationMult + accelerationAdder.y, _acceleration.z* accelerationMult + accelerationAdder.z, drag);
            ...
            m.SetVector("_NoiseParams", new Vector2(_noiseFrequency, _noiseAmplitude*accelerationMult));
        ...
        void Update()
        {
            ...
            props.SetFloat("_ScaleMin", _scale * (1 - _scaleRandomness) * _particleScaleMultiplier);
            props.SetFloat("_ScaleMax", _scale * _particleScaleMultiplier);
